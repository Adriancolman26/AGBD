...
SELECT e.first_name, d.department_name, l.state_province, e.salary, m.first_name FROM employees e
...
-- 4 Crear un nuevo departamento de nombre asesores, 
--   un nuevo tipo de trabajo asesor y asociar un nuevo empleado a ese departamento y tipo de trabajo.
...
VALUES ('Juan', 'Pérez', 'juan.perez@company.com', '555-1234', '2023-06-01', 
(SELECT job_id FROM jobs WHERE job_title = 'Asesor'), 6000, 
(SELECT department_id FROM departments WHERE department_name = 'Asesores'), 100);